...
let number1IsNumber = Number.isInteger(isNumber1)
let number2IsNumber = Number.isInteger(isNumber2)
...
let scorePercentage = ((scoreValue * 100) / maxValue).toFixed(2)
...
let scoreMessage = messagePrefix + " " + String(score)
