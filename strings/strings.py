...
testString2 = testString2.replace("sentence", "best")
testString2 = testString2.replace(".", ",")
temp = "__TEMP__"
testString2 = testString2.replace("first", temp)
testString2 = testString2.replace("second", "first")
testString2 = testString2.replace(temp, "second")
